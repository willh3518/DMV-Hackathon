...
abstract final class AppColors {
  static const Color canvasTop = Color(0xFFF8FCFF);
  static const Color canvasBottom = Color(0xFFE9F5FF);
  static const Color surface = Color(0xFFFFFFFF);
  static const Color surfaceBlue = Color(0xFFE4F2FF);
  static const Color surfaceBlueStrong = Color(0xFFC7E4FF);
  static const Color primary = Color(0xFF2474C6);
